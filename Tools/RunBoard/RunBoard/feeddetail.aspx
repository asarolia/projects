...
<table width="900">
  ...
  <tr>
   ...
   <tr>
     <td colspan="1"><span class="style4">HSBC</span>
     </td>
     <td colspan="1">
     ...
     <td colspan="1" class="style4">Barclays</td>
     <td colspan="1">
     ...
     <td colspan="1" class="style4">Santander</td>
     <td colspan="1">
	...
	<tr>
     <td colspan="1"><span class="style4">TSB</span>
     </td>
     <td colspan="1">
     ...
     <td colspan="1" align ="right">
             <asp:LinkButton ID="tsbButton1" runat="server" onclick="tsb_Click">Graph</asp:LinkButton></td>
     <td colspan="1" align ="center">&nbsp;|&nbsp;</td>
     <td colspan="1">
             <asp:LinkButton ID="tsbButton2" runat="server" onclick="tsbdetail_Click">Detail</asp:LinkButton>
      </td>
	  
	  <td colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	  <td colspan="1"><span class="style4">Barclays You Shaped</span>
     </td>
     <td colspan="1">
     ...
     <td colspan="1" align ="right">
             <asp:LinkButton ID="BYSButton1" runat="server" onclick="BYS_Click">Graph</asp:LinkButton></td>
     <td colspan="1" align ="center">&nbsp;|&nbsp;</td>
     <td colspan="1">
             <asp:LinkButton ID="BYSButton2" runat="server" onclick="BYSdetail_Click">Detail</asp:LinkButton>
      </td>
	</tr>
