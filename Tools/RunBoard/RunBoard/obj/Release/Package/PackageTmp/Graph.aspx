<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Graph.aspx.cs" Inherits="RunBoard.Graph" %>
...
--%>
     ...
     <h1 > Grpahical View : <b>  <asp:Label ID="graphv1" runat="server"></asp:Label>  </b></h1>
...
<p> 
    ...
    <p> 
        <div align="center"><asp:Chart ID="Chart1"  runat="server" Height="296px" Width="568px" 
                BackColor="211, 223, 240" BorderlineDashStyle="Solid" 
                BackGradientStyle="TopBottom" BorderWidth="2px" BorderColor="#1A3B69"  
            DataSourceID="SqlDataSource1">
            <legends> 
