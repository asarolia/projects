...
<p> Date: <asp:TextBox ID="dtlv3" runat="server" Enabled="false"></asp:TextBox>
      ...
      <div id="VGrid">
        ...
        Width="756px">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Day_Fo_Count" HeaderText="&nbsp;&nbsp;Day 4&nbsp;&nbsp;" ItemStyle-HorizontalAlign ="Center" ItemStyle-VerticalAlign ="Middle"
                    SortExpression="Day_Fo_Count" />
                <asp:BoundField DataField="Day_Fi_Count" HeaderText="&nbsp;&nbsp;Day 5&nbsp;&nbsp;" ItemStyle-HorizontalAlign ="Center" ItemStyle-VerticalAlign ="Middle"
                    SortExpression="Day_Fi_Count" />
    ...
    <p> 
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT Error_Ref, Day_O_Count, Day_T_Count, Day_Th_Count, Day_Fo_Count, Day_Fi_Count, Fail_Pgm_Name, Fail_Para_Name  FROM HalErr WHERE RecordDt = @Date " >
            <SelectParameters>               
