...
<p> Date: <asp:TextBox ID="dtlv3" runat="server" Enabled="false"></asp:TextBox>
    ...
    <p> &nbsp;</p>
      <div id="VGrid">
        ...
        Width="756px">
          ...
          <p> &nbsp;</p>
          <asp:GridView ID="GridView2" OnPreRender="grd_Pre1" runat="server" BackColor="#FF9933" 
        ...
        Width="756px">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="OBJECT" HeaderText="&nbsp;&nbsp;Object ID&nbsp;&nbsp;" SortExpression="OBJECT" ItemStyle-HorizontalAlign ="Center" ItemStyle-VerticalAlign ="Middle" />
                <asp:BoundField DataField="STATUS" HeaderText="&nbsp;&nbsp;Status&nbsp;&nbsp;" SortExpression="STATUS" ItemStyle-HorizontalAlign ="Center" ItemStyle-VerticalAlign ="Middle" />
                ...
                <asp:BoundField DataField="Time" HeaderText="&nbsp;&nbsp;Oldest Timestamp&nbsp;&nbsp;" SortExpression="Time" ItemStyle-HorizontalAlign ="Center" ItemStyle-VerticalAlign ="Middle" />
            </Columns>
            <EditRowStyle HorizontalAlign="Center" VerticalAlign="Middle" />
            <FooterStyle BackColor="#C6C3C6" ForeColor="Black" />
            <HeaderStyle Font-Bold="True" BackColor="#33CC33" ForeColor="#0033CC" />
    ...
    <p> 
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
            ...
            SelectCommand="SELECT OBJECT, STATUS, Count, Time FROM deferobjects WHERE RecordDt = @Date" >
            <SelectParameters>               
                 <asp:SessionParameter Name="Date" SessionField="date" />
            </SelectParameters>
        </asp:SqlDataSource>
