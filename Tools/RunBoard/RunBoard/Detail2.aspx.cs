...
namespace RunBoard
{
    public partial class Detail2 : System.Web.UI.Page
    {
        ...
        private void CreateLabel()
        {
            ...
            if (dtlv1.Text == "CARD")
            {
                Processed.Text = "Processed Count&nbsp&nbsp&nbsp&nbsp:&nbspCard Transactions Successfully Authorized ";
                Unprocessed.Text = "Unprocessed Count:&nbspCard Transactions For Which No Response Received From Card Master  ";
                Failed.Text = "Failed Count&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:&nbspCard Transactions Declined During The Day  ";
            }
