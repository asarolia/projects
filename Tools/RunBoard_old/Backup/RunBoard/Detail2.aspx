<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Detail2.aspx.cs" Inherits="RunBoard.Detail2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <p> Date: <asp:TextBox ID="dtlv3" runat="server" Enabled="false"></asp:TextBox>
    <%--<asp:Button ID="Button1" runat="server" onclick="Button1_Click" 
        style="margin-left: 31px" Text="&lt;&lt;" Width="89px" />--%>
