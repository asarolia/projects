        ...
        Width="756px">
            <Columns>
                ...
                <asp:BoundField DataField="Fail" HeaderText="&nbsp;&nbsp;Fail&nbsp;&nbsp;" ItemStyle-HorizontalAlign ="Center" ItemStyle-VerticalAlign ="Middle"
                    SortExpression="Fail" />
                <asp:BoundField DataField="Failed_Threshold_Red" HeaderText="&nbsp;&nbsp;Fail_Lt_Red&nbsp;&nbsp;" ItemStyle-HorizontalAlign ="Center" ItemStyle-VerticalAlign ="Middle"
                ...
                <asp:BoundField DataField="Failed_Threshold_Amber" ItemStyle-HorizontalAlign ="Center" ItemStyle-VerticalAlign ="Middle"
                    HeaderText="&nbsp;Fail_Lt_Amber&nbsp;" SortExpression="Failed_Threshold_Red" />
